<template>
  <section class="container mobile-width margin--auto margin-top--large">
    <h1>Cookies Policy</h1>

    <p>Last updated: October 23, 2019</p>

    <p>Kokebokami ("us", "we", or "our") uses cookies on the kokebokami.com website and the mobile application (the "Service"). By using the Service, you consent to the use of cookies.</p>
