<template>
  <div>
    ...
    <section class="mobile-width margin--auto margin-top--large">
      ...
      <p>
        Kokebokami ("us", "we", or "our") uses cookies on the kokebokami.com
        website and the mobile application (the "Service"). By using the
      ...
      <ul class="arrow-list">
        ...
        <li>
          <p>
            ...
            how the Service is used so that we can make improvements. We may
            also use analytics cookies to test new advertisements, pages,
            features or new functionality of the Service to see how our users
            react to them.
          </p>
        </li>
      </ul>
...
export default {
  ...
  props: {
    breadcrumbs: {
      type: Array,
      default: () => [{ name: "Home", link: "/" }, { name: "Cookies Policy" }]
    }
  }
};
</script>
