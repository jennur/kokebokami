  ...
  <div>
    ...
    <section class="mobile-width margin-auto">
      ...
      <p>
        ...
        relationship with https://kokebokami.com website (the "Service")
        operated by Kokebokami ("us", "we", or "our").
      </p>
      ...
      <p>
        ...
        property of Kokebokami and its licensors. The Service is protected by
        copyright, trademark, and other laws of both the Norway and foreign
      ...
      <p>
        ...
        are not owned or controlled by Kokebokami.
      </p>

      <p>
        Kokebokami has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or
        services. You further acknowledge and agree that Kokebokami shall not be
