<template>
  <div>
    ...
    <section class="mobile-width margin--auto">
      ...
      <p>
        Kokebokami ("us", "we", or "our") operates the https://kokebokami.com
      ...
      <ul class="arrow-list">
        <li>
          ...
          <p>
            Service is the https://kokebokami.com website operated by Kokebokami
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        If you are from the European Economic Area (EEA), Kokebokami legal basis
      ...
      <p>
        Kokebokami will also retain Usage Data for internal analysis purposes.
      ...
      <p>
        Kokebokami will take all the steps reasonably necessary to ensure that
      ...
      <p>
        ...
        certain data protection rights. Kokebokami aims to take reasonable steps
      ...
      <ul class="arrow-list">
        ...
        <li>
          <p>
            ...
            right to withdraw your consent at any time where Kokebokami relied
...
export default {
  ...
  props: {
    breadcrumbs: {
      type: Array,
      default: () => [{ name: "Home", link: "/" }, { name: "Privacy Policy" }]
    }
  }
};
</script>
